...
import atentionIcon from "../images/png/Warning-pana.png";
import { theme } from "../../../global/theme";

const PopUp = ({ state, onTouchStart }) => {
    return (
            ...
            <View onTouchStart={onTouchStart} style={{ backgroundColor: "red", height: "100%", backgroundColor: 'rgba(52, 52, 52, 0.8)' }}>
                <View style={styles.modalContent}>
                    <View style={{ justifyContent: "center", alignItems: "center", marginTop: 20 }}>
                        ...
                        <Text style={styles.textSecondary}>Verifique todos os campos antes de continuar!</Text>
                        <Image source={atentionIcon} style={{ width: 280, height: 210 }} />
                    </View>
                </View>
            </View>
        </Modal>
